...
<head>
    ...
    <title>{{ __('auth.password_new') }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<table class="main-table">
    ...
    <tr>
        <td class="main">
            <h1>{{ __('auth.password_new') }}</h1>
            <br>
            <p>Ви успішнно змінили свій пароль на сайті <a href="{{ route('index') }}">{{ $parsedUrl['host'] }}</a></p>
            <br>
            <p class="text-center"><a class="btn btn-general" href="{{ route('login') }}">{{ __('auth.login') }}</a></p>
            <br>
